...
<head>
    ...
    <meta name="Inventory" content="Inventory Dashboard" />
        ...
        <ul class="nav navbar-nav side-nav nicescroll-bar">
            ...
            <li>
                ...
                <ul id="maps_dr" class="collapse collapse-level-1">
                    ...
                    <li>
                        <a  href="{{route('product.addnewproduct')}}">Add New Product</a>
                    </li>
                    <li>
                        <a  href="{{route('purchase.purchaselist')}}">Purchase List</a>
                    </li>
                    <li>
                        <a  href="#DeletedProductList">Deleted Product List</a>
                    </li>
                    <li>
                        <a  href="#StockOutProduct">Stock Out Product List</a>
                    </li>
                    <li><a href="/product/addproducttype">Add Product Category</a></li>

                    <li><a href="/product/producttypelist"> Product Category List</a></li>
                </ul>
            </li>
            ...
            <li>
                <a href="#" data-toggle="collapse" data-target="#maps_dr2">
                    <div class="pull-left"><i class="zmdi zmdi-map mr-20"></i><span
                            class="right-nav-text">Supplier</span></div>
                    <div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul id="maps_dr2" class="collapse collapse-level-1">
                    ...
                    <li>
                        <a href="#">Deleted Supplier List</a>
                    </li>
                </ul>
            </li>
